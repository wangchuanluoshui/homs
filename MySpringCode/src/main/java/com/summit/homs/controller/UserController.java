...
public class UserController {
	...
	@ResponseBody
    public IResult user(@SessionAttribute("LOGIN_USER") LoginSysUser sessionSysUser){
	...
	@ResponseBody
    public IResult admin(@SessionAttribute("LOGIN_USER") LoginSysUser sessionSysUser){
